...
export const LogoutIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  ...
  >
    <path
      d="M14.08,15.59L10.67,12.19L14.08,8.79L12.67,7.38L7.29,12.77L12.68,18.16L14.09,16.75M19,3A2,2 0 0,1 21,5V9.67L19,7.67V5H5V19H19V16.33L21,14.33V19A2,2 0 0,1 19,21H5C3.89,21 3,20.1 3,19V5C3,3.89 3.89,3 5,3H19Z"
      fill="currentColor"
    />
  </svg>
);
